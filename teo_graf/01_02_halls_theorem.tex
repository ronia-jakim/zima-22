...
\hyperref[cosets-graphs-GB]{[ \worldflag[length=10px, width=5px]{GB}]} \hyperref[cosets-graphs-PL]{[ \worldflag[length=10px, width=5px]{PL}]}
\phantomsection
\label{cosets-graphs-LAN}

\medskip

\hyperref[cosets-graphs-LAN]{[ \worldflag[length=10px, width=5px]{GB}]}
\phantomsection
...
\hyperref[cosets-graphs-LAN]{[ \worldflag[length=10px, width=5px]{PL}]}
\phantomsection
...
\hyperref[missing-soulmate-GB]{[ \worldflag[length=10px, width=5px]{GB}]} \hyperref[missing-soulmate-PL]{[ \worldflag[length=10px, width=5px]{PL}]}
\phantomsection
\label{missing-soulmate-LAN}

\medskip

\hyperref[missing-soulmate-LAN]{[ \worldflag[length=10px, width=5px]{GB}]}
\phantomsection
...
\hyperref[missing-soulmate-LAN]{[ \worldflag[length=10px, width=5px]{PL}]}
\phantomsection
...
\hyperref[hall-polygamous-GB]{[ \worldflag[length=10px, width=5px]{GB}]} \hyperref[hall-polygamous-PL]{[ \worldflag[length=10px, width=5px]{PL}]}
\phantomsection
\label{hall-polygamous-LAN}

\medskip

\hyperref[hall-polygamous-LAN]{[ \worldflag[length=10px, width=5px]{GB}]}
\phantomsection
...
\hyperref[hall-polygamous-LAN]{[ \worldflag[length=10px, width=5px]{PL}]}
\phantomsection
